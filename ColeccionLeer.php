...
$Tabla['table']="Collection";
$Tabla['columns']="''/*/ adminOwner/*/ Name /*/ Supply/*/ Image/*/ Metadata/*/ Data/*/ Contract /*/ Minter";
$Tabla['index']="id";
$Tabla['condition']="";
$Tabla['extra'][0]="actions_colection";
//$Tabla['extra'][8]="ws";
					...
					?>
						...
						?>
								<div class="alert alert-danger fade in alert-msn" role="alert">
									...
									<strong>
										<i class="fa fa-times fa-lg"></i>&nbsp; Oops!... Ocurrio un error al eliminar el elemento:&nbsp;
									</strong>
						...
						?>
								<div class="row">
									...
									?>
											<a data-intro="Insertar nuevo Collection" data-position="top" class="btn btn btn-success" title="Agregar" href="ColeccionCrear.php" >
									...
									?>
										...
										<div class="col-md-4 text-right">
											<div class="form-group" data-intro="B&uacute;squeda general" data-position="bottom">
												<label class="sr-only" for="Search-Table_Collection">
													Busqueda
												</label >
												<div>
													<input id="Search-Table_Collection" class="form-control DataTableFilter" type="text" placeholder="Buscar..." autocomplete="off">
												</div>
											</div>
										</div>
									</div>
								...
								<div class="row">
									<div class="table-responsive col-md-12" align="left">
										<table id="Table_Collection" class="table table-striped table-bordered table-hover datatable" data-records="<?php print $Datos; ?>" data-form="<?php print substr(strrchr($_SERVER['PHP_SELF'],"/"),1); ?>" >
											<thead>
												<tr>
													<th width="1%" title="Seleccionar todo">
														<div align="center">
															<label>
																<input type="checkbox" id="All" data-intro="Seleeciona todos los registros de esta p&aacute;gina" data-position="bottom"/>
															</label>
														</div>
													</th>
														<th class="sortable"><div align="center">Admin Owner</div></th>
														<th class="sortable"><div align="center">Name</div></th>
														<th class="sortable"><div align="center">Supply</div></th>
														<th class="sortable"><div align="center">Image</div></th>
														<th class="sortable"><div align="center">Metadata</div></th>
														<th class="sortable"><div align="center">Data</div></th>
														<th class="sortable"><div align="center">Contract</div></th>
														<th class="sortable"><div align="center">Minter</div></th>
												</tr>
											</thead>
											<tbody>
											</tbody>
									...
									<div class="modal-dialog">
										<div class="modal-content">
											...
											<div class="modal-footer">
												<a class="btn btn-default" id="Cancelar" data-dismiss="modal">
													Cancelar
												</a>
												<a class="btn btn-primary" id="Aceptar" href="">
				...
				if(Get!=''){
					...
					function(data){
						if(cont<2){
							...
							$("#Actualizar").attr('href','CollectionActualizar.php?'+data);
							$("#Aceptar").attr('href','CollectionEliminar.php?.php?'+data);
						}
					});
				}else{
					var href="#";
