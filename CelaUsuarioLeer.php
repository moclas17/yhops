...
$Tabla['columns']="''/*/ NombreCompleto/*/ Usuario/*/ CorreoElectr_onico/*/ ( select Descripci_on from  CelaEstado where CelaEstado.idEstado = CelaUsuario.EstadoActual) /as/ EstadoActual /*/ ( select NombreDelRol from  CelaRol where CelaRol.idRol = CelaUsuario.Rol) /as/ Rol ";
							...
							<div class="row">
								<div class="col-md-12">
									<div class="box-header col-xs-6 text-left">
										<strong>
											<span style="font-size: 18pt;">Listado de Usuarios</span>
										</strong>
									</div>
									...
									<table id="CelaUsuario" class="table table-striped table-bordered hover datatable" data-records="<?php print $Datos; ?>" data-form="<?php print substr(strrchr($_SERVER['PHP_SELF'],"/"),1); ?>" >
										<thead>
											<tr>
												...
												<th class="sortable" width="10%"><div align="center"> Rol</div></th>
