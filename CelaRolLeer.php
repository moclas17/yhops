...
$Tabla['table']="CelaRol";
$Tabla['columns']="''/*/ NombreDelRol/*/ Siglas/*/ Descripci_onDelRol /*/ ''";
$Tabla['index']="idRol";
$Tabla['condition']="";
				...
				<div id="main-container" class="<?php print $registrosMenu>0?'col-sm-offset-3 col-sm-9 col-md-offset-2 col-md-10':'col-sm-12 col-md-12'; ?> main">
							...
							<div class="row">
								<div class="col-md-12">
									<div class="box-header col-xs-6 text-left">
										<strong>
											<span style="font-size: 18pt;">Listado de Roles</span>
										</strong>
									</div>
					...
					?>
						...
						?>
    							...
    							?>
										<a data-intro="Insertar nuevo CelaRol" data-position="top" class="btn btn btn-success" title="Agregar" href="CelaRolCrear.php" >
								...
								?>
									...
									<div class="col-md-4 text-right">
										<div class="form-group" data-intro="Busqueda general" data-position="bottom" >
											<label class="sr-only" for="Search-CelaRol">Busqueda</label>
											<div>
												<input id="Search-CelaRol" class="form-control DataTableFilter" type="text" placeholder="Buscar..." autocomplete="off">
											</div>
										</div>
									</div>
								</div>
								<div class="table-responsive" align="left">
									<table id="CelaRol" class="table table-striped table-bordered hover datatable" data-records="<?php print $Datos; ?>" data-form="<?php print substr(strrchr($_SERVER['PHP_SELF'],"/"),1); ?>" >
										<thead>
											<tr>
												...
												<th class="sortable" width="20%"><div align="center"> Nombre del Rol</div></th>
												<th class="sortable" width="14%"><div align="center"> Siglas</div></th>
												<th class="sortable" width="50%"><div align="center"> Descripci&oacute;n del Rol</div></th>
												<th width="15%"><div align="center"> Privilegios</div></th>
				...
				if(Get!=''){
					...
					function(data){
						if(cont<2){
							...
							$("#Actualizar").attr('href','CelaRolActualizar.php?'+data);
							$("#Aceptar").attr('href','CelaRolEliminar.php?.php?'+data);
						}
					});
				}else{
					var href="#";
