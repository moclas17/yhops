...
$Tabla['table']="CelaMen_u m INNER JOIN CelaMen_u mc ON (m.Categor_ia = mc.idMenu)";
$Tabla['columns']="''/*/ m.Etiqueta /as/ Etiqueta/*/ m.Descripci_on /as/ Descripci_on/*/ m.Referencia /as/ Referencia /*/ mc.Etiqueta /as/ Categor_ia/*/ m.Prioridad /as/ Prioridad/*/ (select NombreDelIcono from CelaIcono where CelaIcono.idIcono=m.Icono) /as/ Icono /*/ m.TipoDeElemento /as/ TipoDeElemento";
$Tabla['index']="m.idMenu";
$Tabla['condition']="";
$Tabla['extra'][0]="actions";
$Tabla['render'][6]="icon";
$Tabla['render'][7]="elemento";
				...
				<div id="main-container" class="<?php print $registrosMenu>0?'col-sm-offset-3 col-sm-9 col-md-offset-2 col-md-10':'col-sm-12 col-md-12'; ?> main">
					...
					<div class="row">
							...
							<div class="row">
								<div class="col-md-12">
									<div class="box-header col-xs-6 text-left">
										<strong>
											<span style="font-size: 18pt;">Listado de Elementos de Men&uacute;</span>
										</strong>
									</div>
						...
						?>
    							...
    							?>
										<a data-intro="Insertar nuevo CelaMen_u" data-position="top" class="btn btn btn-success" title="Agregar" href="CelaMen_uCrear.php" >
								...
								?>
									...
									<div class="col-md-4 text-right">
										<div class="form-group" data-intro="Busqueda general" data-position="bottom" >
											<label class="sr-only" for="Search-CelaMen_u">Busqueda</label>
											<div>
												<input id="Search-CelaMen_u" class="form-control DataTableFilter" type="text" placeholder="Buscar..." autocomplete="off">
											</div>
										</div>
									</div>
								</div>
								<div class="table-responsive" align="left">
									<table id="CelaMen_u" class="table table-striped table-bordered hover datatable" data-records="<?php print $Datos; ?>" data-form="<?php print substr(strrchr($_SERVER['PHP_SELF'],"/"),1); ?>" >
										<thead>
											<tr>
												...
												<th class="sortable" width="25%"><div align="center"> Nombre</div></th>
												<th class="sortable" width="25%"><div align="center"> Descripci&oacute;n</div></th>
												<th class="sortable"  width="20%"><div align="center"> Ruta</div></th>
												<th class="sortable" width="10%"><div align="center"> Clave de Categor&iacute;a</div></th>
												<th class="sortable" width="5%"><div align="center"> Prioridad</div></th>
												<th width="4%"><div align="center"> Icono</div></th>
												<th width="10%"><div align="center"> Tipo de Elemento</div></th>
				...
				if(Get!=''){
					...
					function(data){
						if(cont<2){
							...
							$("#Actualizar").attr('href','CelaMen_uActualizar.php?'+data);
							$("#Aceptar").attr('href','CelaMen_uEliminar.php?.php?'+data);
						}
					});
				}else{
					var href="#";
