...
$Tabla['table']="QRHeader";
$Tabla['columns']="''/*/ Name /*/ Supply /*/ Image ";
$Tabla['index']="id";
$Tabla['condition']=" adminOwner=".$_SESSION['CELA_CveUsuario'.$_SESSION['CELA_Aleatorio']];
$Tabla['extra'][0]="actions_qr";
				...
				<div id="main-container" class="<?php print $registrosMenu>0?'col-sm-offset-3 col-sm-9 col-md-offset-2 col-md-10':'col-sm-12 col-md-12'; ?> main">
							...
							<div class="row">
								<div class="col-md-12">
									<div class="box-header col-xs-6 text-left">
										<strong>
											<span style="font-size: 18pt;">Qr's Collections</span>
										</strong>
									</div>
					...
					?>
						...
						?>
							    ...
							    ?>
										<a data-intro="Insertar nuevo CelaUsuario" data-position="top" class="btn btn btn-success" title="Agregar" href="QRCrear.php" >
									...
									<table id="CelaUsuario" class="table table-striped table-bordered hover datatable" data-records="<?php print $Datos; ?>" data-form="<?php print substr(strrchr($_SERVER['PHP_SELF'],"/"),1); ?>" >
										<thead>
											<tr>
												...
												<th class="sortable" width="20%"><div align="center"> Name</div></th>
												<th class="sortable" width="5%"><div align="center"> Supply</div></th>
												<th class="sortable" width="30%"><div align="center"> Image</div></th>
									...
									<div class="modal-dialog">
										<div class="modal-content">
											...
											<div class="modal-footer">
												<a class="btn btn-default" id="Cancelar" data-dismiss="modal">Cancel</a>
												<a class="btn btn-primary" id="Aceptar" href=""><i class="fa fa-trash-o"></i>&nbsp;Delete</a>
											</div>
										</div>
									</div>
								</div>
